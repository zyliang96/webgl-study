/*
 * @Author: your name
 * @Date: 2021-05-12 13:36:11
 * @LastEditTime: 2021-05-12 18:12:14
 * @LastEditors: Please set LastEditors
 * @Description: In User Settings Edit
 * @FilePath: \webgl-study\src\pages\first\17-异步绘图\index.js
 */
...
export default function index(props) {
    ...
    const init = () => {
        ...
        const newVertexBuffer = gl.createBuffer();
        // 绑定缓冲对象
        gl.bindBuffer(gl.ARRAY_BUFFER, newVertexBuffer);
        // 写入数据
        gl.bufferData(
            gl.ARRAY_BUFFER,
        ...
        // 刷底色
        // gl.clear(gl.COLOR_BUFFER_BIT);
        const a_Position_1 = gl.getAttribLocation(gl.program, "a_Position");
        /**
         * 修改attribute 变量
         * @description:  void gl.vertexAttribPointer(index, size, type, normalized, stride, offset); https://developer.mozilla.org/zh-CN/docs/Web/API/WebGLRenderingContext/vertexAttribPointer
         * @param {*}
